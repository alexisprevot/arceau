...
namespace Arceau\Model\Proxies\__CG__\Arceau\Model\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Arceau\Model\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Arceau\\Model\\Entities\\User' . "\0" . 'id', '' . "\0" . 'Arceau\\Model\\Entities\\User' . "\0" . 'email', '' . "\0" . 'Arceau\\Model\\Entities\\User' . "\0" . 'password', '' . "\0" . 'Arceau\\Model\\Entities\\User' . "\0" . 'nom', '' . "\0" . 'Arceau\\Model\\Entities\\User' . "\0" . 'prenom');
        }
